...
public class BoggleBoard {
    ...
    /**
     * Initializes a 4-by-4 board, randomly created by rolling the Hasbro dice.
     */
    public BoggleBoard() {
        M = 4;
        N = 4;
    ...
    /**
     * Initializes an M-by-N board, randomly created according to the frequencies 
    ...
    /**
     * Returns the character at row i and column j.
     * @param i the row
     * @param j the column
     * @return the character at row i and column j
     */
